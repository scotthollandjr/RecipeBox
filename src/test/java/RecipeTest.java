...
public class RecipeTest {
  ...
  public void find_findsRecipeById_true() {
    ...
    assertTrue(foundRecipe.getName().equals(newRecipe.getName()));
  }
  ...
  public void update_updateRecipeName_true() {
    Recipe newRecipe = new Recipe("5", "Todd's Tacos", "beef, cheese", "Put all the ingredients together");
    newRecipe.save();
    newRecipe.update("3", "", "poo, cheese curds", "");
    assertEquals("poo, cheese curds", Recipe.find(newRecipe.getId()).getIngredients());
  }
  ...
  public void getRecipe_returnsRecipeWithSpecificIngredient_Recipe() {
    ...
    List<Recipe> found = Recipe.getRecipeWithIngredient("%" + "beef" + "%");
